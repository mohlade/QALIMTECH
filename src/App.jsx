...
import pig from "./assets/pig1.jpg";
...
const AboutUs = () => {
  return (
    <Section id="about" className="bg-gradient-to-br from-gray-800 to-gray-900">
      <h2 className="text-3xl font-bold text-amber-400 mb-8 text-center font-poppins">
        About Us
      </h2>
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          <p className="text-gray-300 leading-relaxed font-lato text-lg">
            ...
            of our customers. Our journey began with a small farm and a big
            dream, and today, we continue to grow while staying true to our core
            values.
          </p>
          <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
            ...
            traditions with modern, innovative techniques to create a nurturing
            environment for our livestock. From the feed we provide to the space
            we offer, every detail is considered.
          </p>
          <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
            We are committed to sustainability, ensuring that our farming
            practices have a minimal impact on the environment. We strive to be
            responsible stewards of the land and contribute positively to our
            community. We believe in transparency and are always happy to share
            our practices with those who are interested.
          </p>
        </motion.div>
        <motion.div
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        >
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 shadow-md">
            <h3 className="text-amber-400 text-2xl font-semibold mb-3 font-poppins">
              Get in Touch
            </h3>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                <span className="text-gray-300 font-lato text-lg">
                  Email: info@qalimtechfarms.com
                </span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-gray-300 font-lato text-lg">
...
const HomePage = () => {
  return (
    <Section id="home" className="relative text-white py-40 overflow-hidden">
      ...
      {/* Foreground Content */}
      <div className="relative z-20 flex flex-col md:flex-row items-center justify-center w-full px-4">
        <div className="md:mr-8 mb-8 md:mb-0 text-center">
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="text-5xl md:text-7xl font-bold mb-8 font-poppins text-amber-400"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-2xl text-gray-300 mb-12 font-lato leading-relaxed max-w-3xl mx-auto"
          >
            Discover the best in poultry and pig farming at QalimTech Farms. We
            are dedicated to providing high-quality, healthy livestock through
            sustainable and ethical practices. From free-range chickens to
            sustainably raised pigs, we are committed to excellence.
          </motion.p>
          <motion.div
          ...
          >
            <button
              ...
              className="bg-amber-600/20 text-amber-400 hover:bg-amber-600/30 hover:text-white border border-amber-400 rounded-xl py-4 px-8 text-lg font-semibold transition duration-300"
            >
              Learn More
            </button>
          </motion.div>
...
const ChickensPage = () => (
  ...
  >
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      <div>
        <p className="text-gray-300 leading-relaxed font-lato text-lg">
          At Qalimtech Farms, we take pride in our healthy and well-cared-for
          chickens. We believe that providing them with spacious, clean
          environments and a nutritious, balanced diet is essential to their
          well-being and the quality of our products. Our chickens are raised
          with a focus on both their health and comfort, ensuring they live
          happy and stress-free lives.
        </p>
        <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
          We offer a variety of breeds, each with its unique characteristics, to
          meet the diverse needs of our customers. From free-range chickens that
          roam and forage outdoors to specialized breeds known for their
          exceptional meat or egg-laying capabilities, we have something for
          everyone.
        </p>
        <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
          In addition to our high-quality chickens, we also offer fresh,
          delicious eggs. Our hens are raised with the same care and attention
          to detail as our chickens, and their eggs are a testament to their
          health and well-being. We gather eggs daily, ensuring that they are as
          fresh as possible when they reach your table.
        </p>
        <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
          We are committed to sustainable and ethical practices in our chicken
          and egg production. We believe in treating our animals with respect
          and ensuring that they are raised in a way that promotes their natural
          behaviors.
        </p>
      </div>
      <div>
...
const PigsPage = () => (
  <Section id="pigs" className="bg-gradient-to-br from-gray-900 to-gray-800">
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        <p className="text-gray-300 leading-relaxed font-lato text-lg">
          Our pigs are raised with a focus on welfare and quality. We provide
          them with comfortable housing, a balanced diet, and plenty of space to
          roam. We are committed to sustainable and ethical practices in our pig
          farming.
        </p>
        <p className="text-gray-300 leading-relaxed mt-6 font-lato text-lg">
          We offer a range of breeds, ensuring top-tier quality and taste. Our
          pork products are a testament to our dedication to excellence in every
    ...
    <div className="bg-gray-950 font-lato">
      ...
      <footer className="bg-gray-900 text-white py-7">
        <div className="container mx-auto px-4 md:px-8 lg:px-12 text-center font-poppins text-lg">
          &copy; {new Date().getFullYear()} QalimTech Farms. All rights
          reserved.
        </div>
      </footer>
    </div>
